...
'LBL_SP_WELCOME'=> 'Добро пожаловать в студию портала SugarCRM. Здесь вы можете как отредактировать модули , так и синхронизировать соответствующий портал.<br> Выберите необходимый пункт из списка.',

...
$app_strings = array (
  ...
  'LBL_JS_CALENDAR' => 'Календарь' /*for 508 compliance fix*/,
   ...
   'LBL_EMAIL_ADDRESS_BOOK_ADD'			    => 'Готово',
    ...
    'WARN_BROWSER_VERSION_WARNING' => "<b>Предупреждение:</b> Данная версия браузера не поддерживается.<p></p>Рекомендуются следующие версии браузеров:<p></p><ul><li>Internet Explorer 8 (режим совместимости не поддерживается)<li>Firefox 17<li>Safari 5.1<li>Chrome 24</ul>",
